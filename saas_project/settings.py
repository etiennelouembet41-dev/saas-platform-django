...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME'),        # nom de ta base
        'USER': os.getenv('DB_USER'),       # utilisateur PostgreSQL
        'PASSWORD': os.getenv('DB_PASSWORD'), # mot de passe
        'HOST': os.getenv('DB_HOST'),      # ou l'adresse du serveur
        'PORT': os.getenv('DB_PORT'),           # port par défaut
    }
}
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'rest_framework.authentication.SessionAuthentication',  # permet cookie/session
